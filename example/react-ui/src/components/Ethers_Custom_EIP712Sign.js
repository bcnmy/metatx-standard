...
let config = {
    contract: {
        address: "0x4D022403C5573E9ac657F98B341d191701974418",
...
let domainData = {
    ...
    salt: ethers.utils.hexZeroPad((ethers.BigNumber.from(80002)).toHexString(), 32)
};
    ...
    useEffect(() => {
        async function init() {
            if (
                ...
                console.log("hello eip712");
                // We're creating biconomy provider linked to your network of choice where your contract is deployed
                biconomy = new Biconomy(new ethers.providers.JsonRpcProvider("https://rpc-amoy.polygon.technology/"),
