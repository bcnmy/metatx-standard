...
// Is it possible to make a server call from here to get addresses from system info? 
// If yes do forEach on supportedNetworks and populate them 
...
const getBiconomyForwarder = (provider,networkId) => {
     ...
     helperAttributes.biconomyForwarderDomainData.verifyingContract = forwarderAddress;
...
const getDataToSignForEIP712 = (request) => {
    ...
    const dataToSign = JSON.stringify({
        ...
        domain: helperAttributes.biconomyForwarderDomainData,
...
const getDaiPermit = async(provider,account,daiPermitOptions) => {
    ...
    helperAttributes.daiDomainData.verifyingContract = daiTokenAddressMap[chainId];
    helperAttributes.daiDomainData.chainId = chainId;
    const ethersProvider = new ethers.providers.Web3Provider(provider);
    const signer = ethersProvider.getSigner();
    const dai = new ethers.Contract(helperAttributes.daiDomainData.verifyingContract, helperAttributes.daiAbi, signer);
    ...
    const permitDataToSign = {
        ...
        domain: helperAttributes.daiDomainData,
        primaryType: "Permit",
        message: {
            holder: account,
            spender: spender,
