const EIP712MetaTransaction = artifacts.require("EIP712MetaTransactionUpgradable");
const TestContract = artifacts.require("TestContractUpgradable");
...
contract("EIP712MetaTransactionUpgradable", function ([_, owner, account1]) {

    let eip712MetaTransaction;
    let testContract

    before('before', async function () {
        eip712MetaTransaction = await EIP712MetaTransaction.new("TestContractUpgradable", "1", {
            from: owner
        });
