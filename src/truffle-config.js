...
module.exports = {
  ...
  networks: {
    ...
    maticTest: {
      ...
      network_id: 8995,       // Matic's test network id
      gas: 7000000,
      gasPrice: '0x0',
    ...
    goerli: {
      provider: new HDWalletProvider(mnemonic, `https://eth-goerli.g.alchemy.com/v2/9IkndUtriOboH6ugaciWZkNORDYNi-JD`),
      network_id: 5,       // Ropsten's id
      gas: 30000000000,        // Ropsten has a lower block limit than mainnet
      confirmations: 1,    // # of confs to wait between deployments. (default: 0)
